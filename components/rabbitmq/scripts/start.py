...
if not rabbitmq_endpoint_ip:
    ...
    utils.sudo(['rabbitmqctl', 'set_policy', 'logs_queue_message_ttl',
                '^cloudify-logs$',
                '{\"message-ttl\":' +
                str(rabbitmq_logs_queue_message_ttl) + "}",
                '--apply-to', 'queues'])
    ...
    utils.sudo(['rabbitmqctl', 'set_policy', 'events_queue_message_ttl',
                '^cloudify-events$',
                '{\"message-ttl\":' +
                str(rabbitmq_events_queue_message_ttl) + "}",
                '--apply-to', 'queues'])
    ...
    utils.sudo(['rabbitmqctl', 'set_policy', 'metrics_queue_message_ttl',
                '^amq\.gen.*$',
                '{\"message-ttl\":' +
                str(rabbitmq_metrics_queue_message_ttl) + "}",
                '--apply-to', 'queues'])
    ...
    utils.sudo(['rabbitmqctl', 'set_policy', 'logs_queue_length',
                '^cloudify-logs$',
                '{\"max-length\":' +
                str(rabbitmq_logs_queue_length_limit) + "}",
                '--apply-to', 'queues'])
    ...
    utils.sudo(['rabbitmqctl', 'set_policy', 'events_queue_length',
                '^cloudify-events$',
                '{\"max-length\":' +
                str(rabbitmq_events_queue_length_limit) + "}",
                '--apply-to', 'queues'])
