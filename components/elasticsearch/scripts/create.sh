...
function install_elasticsearch() {
    ...
    ctx logger info "Creating Elasticsearch scripts folder"
    create_dir "${ES_CONF_PATH}/scripts"

    ctx logger info "Deploying Elasticsearch 'append to list' script"
    deploy_blueprint_resource "${CONFIG_REL_PATH}/scripts/append.groovy" "${ES_CONF_PATH}/scripts/append.groovy"
